...
<head>
    ...
    <title>Wolverhampton - Secties</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
</head>
<body class="manliv-body wolves-seat-body">
    <main class="manliv-page wolnot-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="Wolverhampton.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title manliv-title-white">MOLINEUX STADIUM</h1>
            </div>
            <img src="media/wolverhampton.png" alt="Wolves logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond stadion">
                <img src="media/wolvesseating.png" alt="Molineux stadion indeling">
            </div>
