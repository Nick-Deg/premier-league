...
<head>
    ...
    <title>Everton - Secties</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
</head>
<body class="manliv-body everton-seat-body">
    <main class="manliv-page evelei-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="Everton.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title manliv-title-white">GOODISON PARK</h1>
            </div>
            <img src="media/everton.png" alt="Everton logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond stadion">
                <img src="media/evertonseating.png" alt="Goodison Park stadion indeling">
            </div>

            <div class="manliv-list" aria-label="Ticket secties">
                <a href="#" class="manliv-card">
                    <span class="manliv-label">Sectie 1</span>
                    <span class="manliv-price">$329,99</span>
                    <span class="manliv-arrow">&gt;</span>
                </a>

                <a href="#" class="manliv-card">
                    <span class="manliv-label">Sectie 2</span>
                    <span class="manliv-price">$269,99</span>
                    <span class="manliv-arrow">&gt;</span>
                </a>
