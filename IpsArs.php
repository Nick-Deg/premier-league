...
<head>
    ...
    <title>Ipswich Town - Secties</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
</head>
<body class="manliv-body ipswich-seat-body">
    <main class="manliv-page ipsbou-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="ipswich.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title manliv-title-white">PORTMAN ROAD</h1>
            </div>
            <img src="media/Ipswich_Town.png" alt="Ipswich Town logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond stadion">
                <img src="media/ipswichseating.png" alt="Portman Road stadion indeling">
            </div>
