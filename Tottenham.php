...
<head>
    ...
    <title>Tottenham - Wedstrijden</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
</head>
<body class="manu-body">
    <main class="manu-page tottenham-page">
        <header class="manu-topbar">
            <img src="media/Tottenham bal.png" alt="Tottenham links" class="manu-devil">
            <img src="media/Tottenham-Hotspur-Logo.png" alt="Tottenham logo" class="manu-top-logo">
            <img src="media/Tottenham bal.png" alt="Tottenham rechts" class="manu-devil">
        </header>

        <section class="manu-content">
            <a href="Clubs.php" class="manu-back-btn">BACK</a>

            <div class="manu-fixtures" aria-label="Tottenham thuiswedstrijden">
                <article class="manu-match-row">
                    <img src="media/premiere league.png" alt="Premier League" class="manu-league-logo">
                    <img src="media/tot.png" alt="Tottenham" class="manu-team-logo">
                    ...
                    <a href="TotArs.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="TotChe.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="TotBre.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="TotNew.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="TotFul.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="TotEve.php" class="manu-go-btn">&gt;</a>
                </article>
            </div>
        </section>
    </main>
