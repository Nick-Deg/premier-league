        ...
        <section class="manu-content">
            ...
            <div class="manu-fixtures" aria-label="West Ham United thuiswedstrijden">
                <article class="manu-match-row">
                    ...
                    <a href="WesFul.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="WesChe.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="WesCri.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="WesNew.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="WesBre.php" class="manu-go-btn">&gt;</a>
                </article>
                ...
                <article class="manu-match-row">
                    ...
                    <a href="WesMan.php" class="manu-go-btn">&gt;</a>
                </article>
            </div>
        </section>
    </main>
