...
<head>
    ...
    <title>Brentford - Secties</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
</head>
<body class="manliv-body brentford-seat-body">
    <main class="manliv-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="Brentford.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title manliv-title-white">GTECH COMMUNITY STADIUM</h1>
            </div>
            <img src="media/Brentford.png" alt="Brentford logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond stadion">
                <img src="media/brentfordseating.png" alt="Brentford stadion indeling">
            </div>
