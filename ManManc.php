...
<head>
    ...
    <title>Manchester United - Secties</title>
    ...
    <main class="manliv-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="ManUnited.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title">OLD TRAFFORD</h1>
            </div>
            <img src="media/Man united.png" alt="Manchester United logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond stadion">
                <img src="media/seating-man.png" alt="Old Trafford stadion indeling">
            </div>

            <div class="manliv-list" aria-label="Ticket secties">
                <a href="#" class="manliv-card">
                    <span class="manliv-label">Sectie 1</span>
                    <span class="manliv-price">$479,99</span>
                    <span class="manliv-arrow">&gt;</span>
                </a>

                <a href="#" class="manliv-card">
                    <span class="manliv-label">Sectie 2</span>
                    <span class="manliv-price">$379,99</span>
                    <span class="manliv-arrow">&gt;</span>
                </a>
