...
<head>
    ...
    <title>Aston Villa - Secties</title>
    <link rel="stylesheet" href="css/premier.css?v=<?= filemtime('css/premier.css') ?>">
    
</head>
<body class="manliv-body aston-seat-body">
    <main class="manliv-page">
        <header class="manliv-top">
            <div class="manliv-top-left">
                <a href="AstonVilla.php" class="manliv-back manliv-back-inline">BACK</a>
                <h1 class="manliv-title manliv-title-white">VILLA PARK</h1>
            </div>
            <img src="media/aston villa.png" alt="Aston Villa logo" class="manliv-logo">
        </header>

        <section class="manliv-main">
            <div class="manliv-map" aria-label="Plattegrond Villa Park">
                <img src="media/Astonseats.png" alt="Villa Park stadion indeling">
            </div>
            ...
            <div class="manliv-list" aria-label="Ticket secties">
                ...
                <a href="#" class="manliv-card">
                    ...
                    <span class="manliv-price">$169,99</span>
                    <span class="manliv-arrow">&gt;</span>
                </a>
